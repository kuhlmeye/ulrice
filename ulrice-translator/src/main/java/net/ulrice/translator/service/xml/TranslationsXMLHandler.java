...
public class TranslationsXMLHandler implements ContentHandler {

	private IFTranslationService service;
	
	private TranslationDTO currentEntry;	
	
	private String currentText;

	public TranslationsXMLHandler(IFTranslationService service) {
		this.service = service;
	}
	
	@Override
	public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
		if("Translation".equalsIgnoreCase(localName)) {
			currentEntry = new TranslationDTO();
		} 
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		if("Translation".equalsIgnoreCase(localName)) {
			service.createTranslation(currentEntry);
			currentEntry = null;
