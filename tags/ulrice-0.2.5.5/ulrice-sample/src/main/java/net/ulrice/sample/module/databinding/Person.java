...
public class Person {
	...
	private static String LASTNAME_ARR[] = new String[] {
	...
	private static String FIRSTNAME_ARR[] = new String[] {
    ...
    public static Person createRandomPerson() {
    	...
    	person.firstName = FIRSTNAME_ARR[(int)(Math.random()* FIRSTNAME_ARR.length)];
    	person.lastName = LASTNAME_ARR[(int)(Math.random()* LASTNAME_ARR.length)];
