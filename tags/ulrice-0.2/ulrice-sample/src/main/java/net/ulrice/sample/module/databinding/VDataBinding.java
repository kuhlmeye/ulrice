...
import net.ulrice.databinding.impl.converter.NullConverter;
...
public class VDataBinding extends JPanel implements IFView {
	...
	public void initialize() {
		textFieldGA1 = new TextFieldGA<String>("name", new NullConverter<String>());
		textFieldGA2 = new TextFieldGA<String>("name", new NullConverter<String>());
