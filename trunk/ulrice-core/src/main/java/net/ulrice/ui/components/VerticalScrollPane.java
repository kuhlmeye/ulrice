...
/**
 * A {@link JScrollPane} that only scrolls vertically. In contrast to a default {@link JScrollPane}, it sets the
 * preferred size of the component to fit its width, instead of just hiding the horizontal scrollbar. When showing the
 * vertical scrollbar, it tries to enlarge its own size to keep the size of the viewport (this works, for example, in
 * the east or west part of a BorderLayout).
 * 
